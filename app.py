...
def predict_online():
    ...
    try:
        ...
        prompt = (
            ...
            "CHEMICAL_EN:\n"
            "- [EXACT chemical active ingredient name as scientifically registered (e.g. Mancozeb, Carbendazim, Propiconazole, Copper oxychloride). Then write 2-3 sentences: exact dosage, how to mix with water, how to apply on the plant, and how often to spray.]\n"
            "- [EXACT chemical active ingredient name. Then write 2-3 sentences: exact dosage, how to mix with water, how to apply on the plant, and how often to spray.]\n"
            "- [EXACT chemical active ingredient name. Then write 2-3 sentences: exact dosage, how to mix with water, how to apply on the plant, and how often to spray.]\n"
            "- [EXACT chemical active ingredient name. Then write 2-3 sentences: exact dosage, how to mix with water, how to apply on the plant, and how often to spray.]\n"
            "CHEMICAL_MR:\n"
            "- [Copy the EXACT same chemical name from CHEMICAL_EN point 1 without any change or translation. Then translate the full 2-3 sentence instructions into Marathi.]\n"
            "- [Copy EXACT chemical name from CHEMICAL_EN point 2. Then translate the full 2-3 sentence instructions into Marathi.]\n"
            "- [Copy EXACT chemical name from CHEMICAL_EN point 3. Then translate the full 2-3 sentence instructions into Marathi.]\n"
            "- [Copy EXACT chemical name from CHEMICAL_EN point 4. Then translate the full 2-3 sentence instructions into Marathi.]\n"
            "STRICT RULE FOR CHEMICAL_MR: The chemical ingredient name must be 100% identical to CHEMICAL_EN. Do NOT translate, transliterate, or modify the chemical name in any way. Only the instructions after the name are translated into Marathi script.\n"
            "ORGANIC_EN:\n"
            ...
            "FINAL RULES:\n"
            "- Chemical points: exactly 4, each must be 2-3 detailed sentences with dosage, mixing instructions, application method and frequency.\n"
